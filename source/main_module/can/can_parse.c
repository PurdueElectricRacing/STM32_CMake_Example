...
bool initCANFilter()
{
    ...
    CAN1->sFilterRegister[4].FR2 = (ID_INVA_ACTUAL_VALUES_1 << 3) | 4;
    CAN1->FA1R |= (1 << 5);    // configure bank 5
    CAN1->sFilterRegister[5].FR1 = (ID_INVA_ACTUAL_VALUES_2 << 3) | 4;
    CAN1->sFilterRegister[5].FR2 = (ID_INVA_TEMPERATURES_1 << 3) | 4;
    CAN1->FA1R |= (1 << 6);    // configure bank 6
    CAN1->sFilterRegister[6].FR1 = (ID_INVA_TEMPERATURES_2 << 3) | 4;
    CAN1->sFilterRegister[6].FR2 = (ID_INVA_ERROR_1 << 3) | 4;
    CAN1->FA1R |= (1 << 7);    // configure bank 7
    CAN1->sFilterRegister[7].FR1 = (ID_INVA_ERROR_2 << 3) | 4;
