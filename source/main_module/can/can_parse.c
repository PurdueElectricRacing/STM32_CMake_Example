...
bool initCANFilter()
{
    ...
    CAN1->sFilterRegister[5].FR1 = (ID_INVB_INFO << 21);
    CAN1->sFilterRegister[5].FR2 = (ID_INVB_TEMPS << 21);
    CAN1->FA1R |= (1 << 6);    // configure bank 6
    CAN1->sFilterRegister[6].FR1 = (ID_INVB_SET << 21);
    CAN1->sFilterRegister[6].FR2 = (ID_INVB_ERR_1 << 21);
    CAN1->FA1R |= (1 << 7);    // configure bank 7
    CAN1->sFilterRegister[7].FR1 = (ID_INVB_ERR_2 << 21);
