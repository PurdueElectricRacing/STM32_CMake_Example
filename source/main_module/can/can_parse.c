...
bool initCANFilter()
{
    ...
    CAN1->sFilterRegister[14].FR1 = (ID_RAW_THROTTLE_BRAKE << 3) | 4;
    CAN1->sFilterRegister[14].FR2 = (ID_FILT_THROTTLE_BRAKE << 3) | 4;
    CAN1->FA1R |= (1 << 15);    // configure bank 15
    CAN1->sFilterRegister[15].FR1 = (ID_START_BUTTON << 3) | 4;
    CAN1->sFilterRegister[15].FR2 = (ID_MAX_CELL_TEMP << 3) | 4;
    CAN1->FA1R |= (1 << 16);    // configure bank 16
    CAN1->sFilterRegister[16].FR1 = (ID_LWS_STANDARD << 21);
    CAN1->sFilterRegister[16].FR2 = (ID_MAIN_MODULE_BL_CMD << 3) | 4;
    CAN1->FA1R |= (1 << 17);    // configure bank 17
    CAN1->sFilterRegister[17].FR1 = (ID_ORION_CURRENTS_VOLTS << 3) | 4;
    CAN1->sFilterRegister[17].FR2 = (ID_THROTTLE_VCU << 3) | 4;
    CAN1->FA1R |= (1 << 18);    // configure bank 18
    CAN1->sFilterRegister[18].FR1 = (ID_THROTTLE_VCU_EQUAL << 3) | 4;
    CAN1->sFilterRegister[18].FR2 = (ID_AMK_ACTUAL_VALUES_1 << 3) | 4;
    CAN1->FA1R |= (1 << 19);    // configure bank 19
    CAN1->sFilterRegister[19].FR1 = (ID_AMK_ACTUAL_VALUES_2 << 3) | 4;
    CAN1->sFilterRegister[19].FR2 = (ID_AMK_TEMPERATURES_1 << 3) | 4;
    CAN1->FA1R |= (1 << 20);    // configure bank 20
    CAN1->sFilterRegister[20].FR1 = (ID_AMK_TEMPERATURES_2 << 3) | 4;
    CAN1->sFilterRegister[20].FR2 = (ID_FAULT_SYNC_PDU << 3) | 4;
    CAN1->FA1R |= (1 << 21);    // configure bank 21
    CAN1->sFilterRegister[21].FR1 = (ID_FAULT_SYNC_DASHBOARD << 3) | 4;
    CAN1->sFilterRegister[21].FR2 = (ID_FAULT_SYNC_A_BOX << 3) | 4;
    CAN1->FA1R |= (1 << 22);    // configure bank 22
    CAN1->sFilterRegister[22].FR1 = (ID_FAULT_SYNC_TORQUE_VECTOR << 3) | 4;
    CAN1->sFilterRegister[22].FR2 = (ID_FAULT_SYNC_TEST_NODE << 3) | 4;
    CAN1->FA1R |= (1 << 23);    // configure bank 23
    CAN1->sFilterRegister[23].FR1 = (ID_SET_FAULT << 3) | 4;
    CAN1->sFilterRegister[23].FR2 = (ID_RETURN_FAULT_CONTROL << 3) | 4;
    CAN1->FA1R |= (1 << 24);    // configure bank 24
    CAN1->sFilterRegister[24].FR1 = (ID_DAQ_COMMAND_MAIN_MODULE << 3) | 4;
    /* END AUTO FILTER */
