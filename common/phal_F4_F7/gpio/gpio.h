...
//UART/USART
#define GPIO_INIT_USART_TX(port, pin) GPIO_INIT_AF(port, pin, 7, GPIO_OUTPUT_ULTRA_SPEED, GPIO_OUTPUT_PUSH_PULL, GPIO_INPUT_OPEN_DRAIN)
#define GPIO_INIT_USART_RX(port, pin) GPIO_INIT_AF(port, pin, 7, GPIO_OUTPUT_ULTRA_SPEED, GPIO_OUTPUT_OPEN_DRAIN, GPIO_INPUT_OPEN_DRAIN)
